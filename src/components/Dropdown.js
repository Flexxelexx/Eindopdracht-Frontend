...
//         Portfolio
//       </div>
//       <div className={setClassNames(4)} onClick={() => pushToRoute("/upload")}>
//         Upload
//       </div>
//       <div className={setClassNames(5)} onClick={() => pushToRoute("/account")}>
//         Account
//       </div>
//       <div
...
//       </div>
//       <div className={setClassNames(7)} onClick={() => pushToRoute("/contact")}>
//         Contacteer ons
//       </div>
//     </div>
//   );
